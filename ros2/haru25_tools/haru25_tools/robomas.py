...
from haru25_msgs.msg import CANArray, CAN
...
class MainWindow(QMainWindow):
    def __init__(self, parent=None):
        ...
        #Icon設定
        self.setWindowIcon(QIcon(os.path.join(dir, "doya2.png")))
        ...
        #グラフの最大値
        self.plot[0].setAxisScale(QwtPlot.yLeft, -10, 10.) # 電流
        self.plot[1].setAxisScale(QwtPlot.yLeft, -60, 60.) # 速度
